...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="agileits-w3layouts-info">
						...
						<p>Si está buscando los mejores juegos de Xbox, ha venido al lugar correcto. Estamos aquí para ayudarlo a llenar su biblioteca de juegos con los mejores juegos disponibles en este momento para la consola más nueva de Microsoft, y continuaremos agregando a esta lista a medida que se lancen más juegos imperdibles en el futuro cercano. </p>
					</div>
				</div>
			</div>
		</div>
   ...
   <!-- shop -->
	<div class="modal-content">
		<img src="../images/xbx.jpg" style="width:100%;">
	</div>
	<div class="modal-content">
		<img src="../images/xcontroller.jpg" style="width:100%;">	
	</div>
	<div class="modal-content">
		<img src="../images/xgames.jpg" style="width:100%">
	</div>
	<!-- //shop -->
	<!-- footer -->
	<div class="footer">
